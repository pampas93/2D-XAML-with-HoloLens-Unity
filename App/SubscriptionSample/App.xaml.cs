...
namespace SubscriptionSample
{
    ...
    sealed partial class App : Application
    {
        ...
        private async Task InitialiseAppViewManager()
        {
            ...
            var mainView = await Adept.AppViewManager.CreateFromCurrentDispatcherAsync("MainPage");

            // Create a new 2D view for the "Content" page.
            var contentPage = await Adept.AppViewManager.CreateNewAsync("ContentPage", typeof(ContentPage));
        }
